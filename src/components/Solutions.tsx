    ...
    <section id="solutions" className="relative py-24 lg:py-32 border-y border-white/10 bg-white/[0.015]">
      <div className="max-w-site mx-auto px-5 lg:px-8">
        <Reveal className="text-center max-w-2xl mx-auto">
          <span className="label-mono">// PROBLEM → SOLUTION</span>
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-4">
          {items.map((it, idx) => {
            const Icon = it.icon;
            return (
              <Reveal key={it.problem} delay={(idx % 2) * 100} className="rounded-3xl border border-white/10 bg-white/[0.03] overflow-hidden">

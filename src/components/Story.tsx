        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="grid grid-cols-5 grid-rows-6 gap-3 h-[420px] sm:h-[480px]">
              <div className="col-span-3 row-span-6 rounded-3xl overflow-hidden shadow-soft ring-1 ring-black/5">
                <img src={asset("img/consult.jpg")} alt="歯科医師と患者の診療シーン" className="w-full h-full object-cover" loading="lazy" />
              </div>
              <div className="col-span-2 row-span-3 rounded-3xl overflow-hidden shadow-soft ring-1 ring-black/5">
            ...
            {/* 引用バッジ */}
            <div className="absolute -bottom-6 left-4 max-w-[260px] rounded-2xl bg-emerald-600 text-white shadow-glow px-5 py-4">
              <Quote className="w-5 h-5 text-emerald-200" />
              <p className="mt-1.5 text-[13.5px] font-bold leading-[1.6]">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="mt-4 font-jp font-black tracking-tight text-ink text-[28px] lg:text-[40px] leading-[1.25]">
              現場を知る人間が、
              <br />
              現場のために。
            </h2>
            ...
            <div className="mt-8 grid sm:grid-cols-3 gap-3">
              {[
                ...
                const Icon = b.icon;
                return (
                  <div key={b.title} className="rounded-2xl border border-emerald-100 bg-emerald-50/40 px-4 py-4">
                    <span className="grid place-items-center w-10 h-10 rounded-xl bg-white text-emerald-600 shadow-sm">
                      <Icon className="w-5 h-5" strokeWidth={1.9} />
                    </span>
                    <p className="mt-3 text-[14px] font-bold text-ink">{b.title}</p>
                    <p className="text-[12px] text-ink-muted mt-0.5 leading-snug">{b.desc}</p>
                  </div>
                );
              })}
            </div>

            <p className="mt-6 text-[11.5px] text-ink-muted/70">

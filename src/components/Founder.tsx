          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {["開業医（院長）", "開業医（知人）", "大学非常勤講師（歯科）"].map((role) => (
                <span key={role} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11.5px] font-bold border" style={{ borderColor: `${GREEN}60`, color: NAVY, backgroundColor: GREEN_LIGHT }}>

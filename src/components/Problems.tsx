...
function IllustrationArea({ icon: Icon, iconColor, tall = false }: {
  ...
  return (
    ...
    >
      <div className="absolute w-28 h-28 rounded-full opacity-10" style={{ backgroundColor: iconColor }} />
    ...
    <section className="bg-white py-16 md:py-20">
      <div className="max-w-[1080px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          {bigCards.map((card) => (
            <a key={card.label} href="#features" className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow block">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {wideCards.map((card) => (
            <a key={card.label} href="#features" className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex min-h-[110px]">

...
export const COMPANY = {
  ...
  established: "2025年",
  business:
    "ホームページ制作（医療系全般）、予約・経営管理システム「Arche」、Googleクチコミ増援サービス「Q-re」、審美歯科プラットフォーム「シカエル」、その他IT全般",
} as const;

/** 事業・サービス（実サービス。推し＝HP制作＋Arche を先頭に） */
export const SERVICES = [
  {
    ...
    name: "ホームページ制作",
    en: "Web Production",
    desc: "歯科をはじめ医療系ならなんでも対応。デザインから公開まで一貫制作し、患者に選ばれ・予約につながるサイトをつくります。",
    img: "img/web.jpg",
    href: CONTACT_MAILTO,
    cta: "制作を相談する",
    star: true,
  },
  {
    ...
    desc: "オンライン予約に加え、リコール・リマインダー・経営分析まで。歯科に最適化しつつ、UI調整で医療全般にも対応できます。",
  ...
  },
  {
    key: "qre",
    no: "03",
    name: "Q-re（Googleクチコミ増援）",
    en: "Review Boost",
    desc: "来院後のアンケートで満足度を測り、高評価の方をGoogleクチコミへご案内。低評価は院内へのフィードバックに。評判と改善を同時に。",
    img: "img/smile.jpg",
    href: CONTACT_MAILTO,
    cta: "相談する",
  },
  {
    key: "shikaeru",
    no: "04",
    name: "シカエル（審美歯科プラットフォーム）",
    en: "Aesthetic Dentistry",
    desc: "“トリビューの審美歯科版”。症例やクチコミから審美歯科を探して予約できる、患者と医院をつなぐプラットフォームです。",
    img: "img/consult.jpg",
    href: CONTACT_MAILTO,
    cta: "詳しく聞く",
  },
  {
    ...
    name: "その他 IT全般",
    en: "IT Support",
    desc: "業務効率化・ツール導入・自動化など、「ITのことならなんでも」。お困りごとからお気軽にご相談ください。",
    img: "img/team.jpg",
    href: CONTACT_MAILTO,
    cta: "相談する",
  },
